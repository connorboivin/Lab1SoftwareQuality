	...
	*/
	...
	public static Binary or(Binary num1, Binary num2) {
		...
		for (int i = 0; i < maxLength; i++) {
			char bit1 = (i < length1) ? num1.number.charAt(length1 - i - 1) : '0';
			char bit2 = (i < length2) ? num2.number.charAt(length2 - i - 1) : '0';
	...
	public static Binary multiply(Binary num1, Binary num2) {
		...
		for (int i = num2.number.length() - 1; i >= 0; i--) {
			...
			tempNum1 = new Binary(tempNum1.number + "0"); // Shift left
		}
		return result;
	}
